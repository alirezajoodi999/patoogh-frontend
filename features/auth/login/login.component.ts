      ...
      <div class="auth-card">
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="auth-form">
          ...
          <div class="form-options">
            ...
            <a routerLink="/auth/forgot-password" class="forgot-link">فراموشی رمز عبور؟</a>
          </div>
        ...
        <div class="auth-footer">
          <p class="footer-text">
            حساب کاربری ندارید؟
            <a routerLink="/auth/register" class="register-link">ثبت‌نام کنید</a>
          </p>
        </div>
      </div>
    </div>
...
export class LoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.login({ email, password, rememberMe }).subscribe({
      ...
      error: (error) => {
        this.loading = false;
        this.errorMessage = error.error?.message || 'خطا در ورود به سیستم. لطفاً دوباره تلاش کنید.';
